      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#BDC3C7" }}>
              Platform pembelajaran algoritma interaktif untuk siswa SMA/SMK
              Indonesia. Belajar coding dengan cara yang menyenangkan dan mudah
              dipahami.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm mb-4" style={{ color: "#BDC3C7" }}>
        ...
        >
          <p className="text-sm" style={{ color: "#BDC3C7" }}>
            ...
            <span style={{ color: "#F39C12" }}>❤️</span> untuk pendidikan
            Indonesia.
          </p>
        </div>
      </div>
